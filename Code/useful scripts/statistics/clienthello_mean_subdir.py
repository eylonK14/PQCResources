...
def main(directory):
    """
    Recursively walks through the directory (and subdirectories), processes each
    .pcap file to collect 'Wireshark-like' ClientHello handshake lengths,
    ...
    # Walk through all subdirectories to find .pcap files
    ...
    # Compute overall statistics across all PCAPs
    ...
    print(f"Mean handshake length:        {mean_len:.2f} bytes.")
