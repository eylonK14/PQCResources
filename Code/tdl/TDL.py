    ...
    def on_update(self, packet, flow):
        ...
        if packet.protocol in [6, 17]:  # TCP or UDP only.
            ...
            if len(vf_port) < 30 and len(vf_ip) < 30:
                ...
                #is_tcp = packet.protocol == 6  # TCP
                #is_ack_only = is_tcp and packet.ack == 1 and packet.syn != 1 and packet.fin != 1 and packet.psh != 1 and packet.rst != 1 and packet.payload_size == 0
                #if not is_ack_only:
                if True:
